...
function decide(){
	if( connacht == true ){
		if( caves ){
			...
			console.log("Caves good");
			//msg = function Inishbofin();
		}
		else if( heights ){
			msg = ("Dún Aonghasa - Inis Mór");
			console.log("Heights good");
			//function Inis();
		}
		else if( easy ){
	...
	else if(munster===true){
		if(caves===true){
			msg = ("Mullaghmore, The Burren");
			//console.log("Caves good");
			//function Burren();
		}
		else if(heights===true){
			msg = ("Carrauntoohil");
			console.log("Heights good");
